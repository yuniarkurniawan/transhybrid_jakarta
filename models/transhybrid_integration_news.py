...
class TranshybridIntegrationnNews(models.Model):
	...
	# SALE ORDER
	name 					=	fields.Char('BAI Number')
	name_show 				=	fields.Char('BAI Number')
	...
	def get_baa_number(self):
		...
		if(self.sale_order_line_service):
			...
			tmpLoanNumber.append("/BAI-PROJECT/")
	...
	def create(self, values):
		...
		return super(TranshybridIntegrationnNews, self).create(values)
